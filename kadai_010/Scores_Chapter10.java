...
public class Scores_Chapter10 {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            //検索
            String serch = "SELECT id,name,score_math,score_english FROM scores ORDER BY score_math DESC,score_english DESC;";
            System.out.println("数学・英語の点数が高い順に並べ替えました");
            ResultSet result = statement.executeQuery(serch);
            while(result.next()) {
